...
//                signin.login(LoginActivity.this, Profile.class).execute();
//            }
//        }).execute();
...
//        pinpointManager.getAnalyticsClient().submitEvents();
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    String deviceToken =
                            InstanceID.getInstance(LoginActivity.this).getToken(
                                    "854443031980",
                    ...
                    Log.d("HEREHREHREHRHEHREHRE","THRE IS AN AROUJLFKJFKLD");
                    e.printStackTrace();
                }
            }
        }).start();
